...
/*   Updated: 2021/08/19 17:12:52 by sguilher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	di_test()
{
	...
	check_return(result1, result2);
	result1 = printf("number %%i using pointer = |%i|\n", *ptr);
	result2 = ft_printf("number %%i using pointer = |%i|\n", *ptr);
	check_return(result1, result2);
	result1 = printf("number %%i > maximum signed integer = |%i|\n", 2147483648);
	result2 = ft_printf("number %%i > maximum signed integer = |%i|\n", 2147483648);
	check_return(result1, result2);
	result1 = printf("number %%i < minimum signed integer = |%i|\n", -2147483649);
	result2 = ft_printf("number %%i < minimum signed integer = |%i|\n", -2147483649);
	check_return(result1, result2);
